...
const News=(props)=> {
    ...
    const[totalResults,settotalResults]  = useState(0)
        ...
        const update =async ()=>{
            ...
            const url=`https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=c84ff6216f08415597e0f0fc2dada9c7&page=${page}&pageSize=${props.pageSize}`;
            setLoading(true);
